...
object MethodNotations_Exercises extends App {

  /*
  Exercisses --> SEE NOTATIONS_EXERCISES.scala class
  ...
  //Exercise 1
  println((marta+"The RockStar") () )
    /**
     The line above means:
     marta+"The RockStar" -> returns an object
     () right after calls the apply method
     --> println((marta+"The RockStar").apply() ) it does the same as the above
     */
